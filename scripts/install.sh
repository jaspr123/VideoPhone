...
echo ""
echo "If 'pip install lgpio' failed to build (no wheel for this board), try:"
echo "  sudo apt-get install -y python3-lgpio"
echo "and re-run this script. The hook switch also needs your user in the"
echo "'gpio' group (the default user on Raspberry Pi OS already is)."
